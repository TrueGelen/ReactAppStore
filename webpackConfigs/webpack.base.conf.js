...
// todo: settled on остановился на том, что нужно заменить / на math.div. Да вот только / в основном используется в smart-gride
// сам лаврик библиотеку не поддреживает и вообще там нет и 300-сот скачиваний в неделю. Может стоит подумать о других решениях